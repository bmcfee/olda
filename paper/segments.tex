...
Note that different songs have different durations, so the dimensionality of $R$ varies. 
...
Rather than use $R$ directly, we introduce \emph{latent structural repetition}, which compresses each
