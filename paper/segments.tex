...
the resulting low-dimensional features.  In practice, small values of $d$ suffice to capture high-level structure: in the given
example, segment boundaries are encoded within the top two factors.
