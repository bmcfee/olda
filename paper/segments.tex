...
to maximize $F_{0.5s}$ score (see below) on the training set.

We report the following boundary detection metrics:
...
\item[Boundary deviation] Median time (seconds) from true to predicted boundaries (T2P) and vice versa (P2T). 
\end{description}
