...
% While a multi-scale view can be useful in some scenarios --- such as interactive data exploration --- standard evaluations rely on flat segmentations. 
...
\end{align*}
Intuitively, $A_\text{O}$ measures the deviation of neighboring segments $(c, c+1)$ from the mutual centroid $\mu_{c+}$, \ie,
...
clustering algorithm described in \Cref{sec:clustering}.
